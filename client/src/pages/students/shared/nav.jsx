        ...
        <div className="fixed top-20 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-xl border-b border-slate-700/50 lg:hidden animate-in slide-in-from-top-2 duration-300">
          <div className="px-4 py-6 space-y-2">
            ...
            <div className="pt-4 border-t border-slate-700/50 space-y-2">
              <button className="w-full flex items-center gap-4 px-4 py-3 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 rounded-2xl text-white font-medium transition-all duration-300 shadow-lg shadow-red-500/25">
