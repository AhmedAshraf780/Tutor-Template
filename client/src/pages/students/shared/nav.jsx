        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`relative flex items-center gap-3 ${isActive ? "text-white" : "group-hover:scale-110 transition-transform"}`}
                    >
            ...
            <div className="hidden md:flex items-center gap-3">
              <button
                className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 rounded-2xl text-white font-medium transition-all duration-300 shadow-lg shadow-red-500/25 hover:shadow-red-500/40 transform hover:scale-105"
            ...
            >
              <div className="relative w-6 h-6">
                <Menu
                  className={`w-6 h-6 text-slate-300 transition-all duration-300 ${open ? "opacity-0 rotate-180" : "opacity-100"}`}
                />
                <X
                  className={`absolute inset-0 w-6 h-6 text-slate-300 transition-all duration-300 ${open ? "opacity-100 rotate-0" : "opacity-0 -rotate-180"}`}
                />
              </div>
            </button>
          </div>
